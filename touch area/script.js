...
function clearCanvas() {
    // 清除多邊形列表
    polygons = { red: [], blue: [], green: [] };

    // 重置顯示的面積和結果
    redAreaDisplay.textContent = '0';
    blueAreaDisplay.textContent = '0';
    greenAreaDisplay.textContent = '0';
    redResultDisplay.textContent = '0';
    blueResultDisplay.textContent = '0';
    greenResultDisplay.textContent = '0';
